...
import MyBlog from "./Component/Main/Myblog";
import SingleBlog from "./Component/Main/Singleblog";
import { blogs } from "./Component/Main/Blogdata"; // Import blogs data
  ...
  const routes = useRoutes([
    {
      ...
      children: [
        ...
        },
        {
          ...
          element: (
            <>
              <PageTitle title="Mon-Chaufferurs | Blog" />
              <MyBlog blogs={blogs} /> {/* Pass blogs prop */}
            </>
          ),
        },
        {
          ...
          element: (
            <>
              <PageTitle title="Mon-Chaufferurs | Blog Details" />
              <SingleBlog />
            </>
          ),
        },
        ...
        },
        {
          ...
          element: (
            <>
              <PageTitle title="Mon-Chaufferurs | Confirm Booking" />
              <BookingConfirmation />
            </>
          ),
        },
