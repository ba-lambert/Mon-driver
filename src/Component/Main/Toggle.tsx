...
const DriverRecruitmentForm = () => {
  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-wrap sm:grid sm:grid-cols-4  justify-center gap-10 items-center sm:items-start  sm:py-10 bg-emerald-100 bg-opacity-90 p-8 text-gray-500 font-sans rounded-t-lg shadow-lg">
        <motion.div
          initial={{ opacity: 0, y: 50 }}
