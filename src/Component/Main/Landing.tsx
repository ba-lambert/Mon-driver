...
export default LandingPage;
 ...
 const WhyUs = () => {
   ...
   return (
     <div className="flex flex-col max-w-screen-2xl mx-auto sm:flex-row justify-center items-center p-6 sm:mt-32 h-auto sm:h-[100vh]">
       <motion.div
       ...
       >
         <div className="bg-blue-100 p-6 sm:p-16 text-md text-gray-700 rounded-lg">
           ...
           <p className="mb-4">
             ...
             spontaneous weekend getaway, or prioritizing the safety of
             yourself, your vehicle, and your belongings, you can always find a
             driver who meets your preferences at MonChauffeur.
           </p>
         </div>
       </motion.div>
