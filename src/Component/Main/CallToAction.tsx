      ...
      <div className="w-full">
        ...
        >
          <motion.div
              ...
              className="absolute flex justify-center items-center w-10/12 h-full sm:top-4 top-8 xl:top-5 left-20 sm:left-52 transform -translate-x-1/2 sm:translate-x-0"
          >
            <img
                src={call}
                alt="telephone"
