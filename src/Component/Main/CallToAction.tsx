    ...
    return (
        <div className="w-full">
            ...
            >
                ...
                />
                <div
                    className="absolute w-full h-full flex justify-end items-center right-0 sm:right-10 p-5 sm:p-44 xl:right-20 xl:p-44">
            ...
            <div
                className="bg-blue-900 p-8 text-white bg-cover text-center flex flex-col sm:flex-row items-center"
            ...
            >
                ...
                >
                    ...
                    <p className="sm:mb-6 sm:text-xl">
                        From our fleet of vehicles and from our drivers community, book a car and a driver for your
                        planned drive at a good price.
                    </p>
                </motion.div>
                <motion.div
                    initial={{opacity: 0, y: 50}}
                ...
                >
                    <div className="relative w-[300px] h-[300px] sm:w-[600px] sm:h-[500px]">
                        {/* Top Image */}
                        <div
                            className="absolute flex items-center justify-center w-32 h-32 sm:w-52 sm:h-52 rounded-full top-0 left-1/2 transform -translate-x-1/2 transition-transform duration-500 hover:scale-105">
                            <img src={c1} alt="Vehicle 1" className="w-full h-auto"/>
                        </div>

                        {/* Right Image */}
                        <div
                            className="absolute flex items-center justify-center w-28 h-28 sm:w-52 sm:h-52 rounded-full top-1/2 right-0 transform -translate-y-1/2 transition-transform duration-500 hover:scale-105">
                            <img src={c2} alt="Vehicle 2" className="w-full h-auto"/>
                        </div>

                        {/* Bottom Image */}
                        <div
                            className="absolute flex items-center justify-center w-28 h-28 sm:w-52 sm:h-52 rounded-full bottom-0 left-1/2 transform -translate-x-1/2 transition-transform duration-500 hover:scale-105">
                            <img src={c3} alt="Vehicle 3" className="w-full h-auto"/>
                        </div>

                        {/* Left Image */}
                        <div
                            className="absolute flex items-center justify-center w-28 h-28 sm:w-52 sm:h-52 rounded-full top-1/2 left-0 transform -translate-y-1/2 transition-transform duration-500 hover:scale-105">
                            <img src={c4} alt="Vehicle 4" className="w-full h-auto"/>
                        </div>

                        {/* Center Button */}
                        <div
                            className="absolute flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-green-500 text-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 transition-transform duration-500 hover:scale-110">
